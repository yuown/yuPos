...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "yuPos@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "yuPos API";

        private String description = "yuPos API documentation";
